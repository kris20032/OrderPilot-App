...
**Obecny etap:** TASK 2.1.1 ukończone — przejście do TASK 4.1.1
...
| 5 | TASK 4.1.1 — OfferParser interface | ⏳ Następny |
...
**Krzysztof:** TASK 4.1.1 — OfferParser interface
**Tata:** —
**Łukasz:** —
...
**TERAZ:** TASK 4.1.1 — OfferParser interface (Sonnet)
