...
**Ostatnia aktualizacja:** 2026-05-13 (Day 10 — v1.0.4 version bump)
**Obecny etap:** **Closed Testing Day 10** (Day 0 = 2026-05-03, Day 14 = 2026-05-17). v1.0.3 LIVE (10/14 days continuous opted-in 12 testerów per Play Console dashboard). **v1.0.4 version bump done 05-13** (versionCode 4→5, versionName 1.0.3→1.0.4, commit `8e4686e`). Kod v1.0.4 (commit `f58ec8c`) gotowy od Day 9. Build AAB + upload Day 11 (jutro 05-14). Wszystkie wymagane pola Production submit zamknięte, Default store listing pending w Publishing overview do Day 14 one-shot submitu razem z v1.0.4 AAB.
...
| **High** | **3+ AAB updates podczas 14-day clock** — v1.0.2 ✅ Released 05-06, v1.0.3 ✅ LIVE od 05-09 (Dominik confirmed 05-11), v1.0.4 kod gotowy 05-12 + version bump 05-13 (#37 decimal + #38 combined thresholds), build/upload Day 11 (05-14) | W TOKU |
...
| Data | Zmiana |
|------|--------|
| 05-13 | **Day 10 — v1.0.4 version bump** (`versionCode 4→5`, `versionName "1.0.3"→"1.0.4"` w `OrderPilot/app/build.gradle.kts`, commit `8e4686e`). Kod (commit `f58ec8c`) gotowy od Day 9. Build AAB + upload do Closed Testing planowany jutro (Day 11 / 05-14). Play Console dashboard potwierdza 12 testerów opted-in 10/14 days continuous |
