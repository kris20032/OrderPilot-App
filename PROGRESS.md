...
**Obecny etap:** Play Store prep — Batch 1 (manifest/config/strings) + fix Setup wizard + Batch 2 (audyty V20/V6/V4/V5) + Batch 3 (DisclosureActivity + consent flag + flow wiring) + Path A Phase 3 (Tasks 3.6 PP link w Settings, 3.7 About disclaimers, 3.8 wording reframe „monitoring" → „wykrywanie zleceń") zrobione. Następnie: Batch 4 (signingConfigs po wygenerowaniu keystore) + user actions (Privacy Policy hosting, Dev Account, store assets). Plan: `docs/play-store/02_implementation_plan.md`.
