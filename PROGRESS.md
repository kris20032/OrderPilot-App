...
| **High** | **Play Store SEO fix** — apka niewidoczna gdy user wpisuje „order pilot" (z spacją). App name + Short description + pierwsze 250 chars Full description wymagają edycji żeby fraza „Order Pilot" była explicit. Szczegóły w `docs/promo/LAUNCH_PLAN.md` Etap 1.5 Issue #1. BLOCKING przed outreachem do grup. | 🔴 TODO (30-60 min + 24-48h review) |
| **High** | **Grafiki FB** — cover graphic w niskiej jakości + brak showcase realnej belki nad apką kuriera. Nowa cover 1640×924 (Canva/Figma) + profile pic + 3-4 screenshoty do postów. Szczegóły w `docs/promo/LAUNCH_PLAN.md` Etap 1.5 Issue #2. | 🟡 TODO (1-2h DIY lub 24-48h outsourcing) |
