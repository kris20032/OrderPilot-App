...
**Obecny etap:** Audyt niezawodności + 4 HIGH fixy (BOOT_COMPLETED, watchdog race, health-check delay, notification UX) — branch `fix/phantom-overlay-guard`, czeka na build + test (reboot/kill/Doze).
