...
|-----------|---------|--------|
| 🔴 **High** | **Merge łańcucha `feat/wizard-v2`** (KOMPLETNA PACZKA v1.1: sprint #1 + wizard v2.1 z redesignem + sprint #2 + redesign ekranu głównego + fixy M8/M9) — test na telefonie (świeża instalacja → przejść wizard; język UA/RU po Save; Stop chowa belkę; zmiana globalnego czasu belki nie psuje platform) + merge do `main`. Build, 156 testów i weryfikacja emulatorem zielone (2026-07-04) | Kod GOTOWY, test na telefonie + merge TODO (Krzysztof) |
